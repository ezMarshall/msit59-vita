...
CREATE TABLE Customers(
	...
	CustomerAddressCity nvarchar(10) ,
	CustomerAddressDistrict nvarchar(10) ,
	CustomerAddressDetails nvarchar(50) ,
...
CREATE TABLE Orders (
  ...
  OrderAddressCity nvarchar(10),
  OrderAddressDistrict nvarchar(10),
  OrderAddressDetails nvarchar(50),
...
CREATE TABLE StoreOpeningHours(
	...
	StoreOpenOrNot bit DEFAULT (0),
	StoreOpeningTime time　DEFAULT (''),
	StoreClosingTime time　DEFAULT (''),
